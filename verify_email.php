...
if(isset($_POST['verify_email'])){
    $vcode = $db_handle->checkValue($_POST['vcode']);
    $email = $_GET['email'];
    ...
    if($vcode == $verification){
        ...
        session_start();
        $_SESSION['id'] = $fetch_customer [0]["id"];
        echo "<script>
...
<head>
    ...
    <title>Verify Image - Enjoy</title>
                        ...
                        <form class="row g-4" action="#" method="post">
                            <div class="col-12">
                                <div class="form-floating theme-form-floating log-in-form">
                                    <input type="text" class="form-control" id="email" placeholder="<?php echo '驗證碼';?>" name="vcode">
                                    <label for="email"><h4><?php echo '驗證碼';?></h4></label>
                                </div>
                            </div>

                            <div class="col-12">
                                <button class="btn btn-animation w-100 justify-content-center" name="verify_email" type="submit"><?php echo '驗證電子郵件';?></button>
                            </div>
                        </form>
                    </div>
