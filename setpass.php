                        ...
                        <form class="row g-4" action="#" method="post">
                            <div class="col-12">
                                <div class="form-floating theme-form-floating log-in-form">
                                    <input type="password" class="form-control" id="email" placeholder="<?php echo '新密碼';?>" name="password">
                                    <label for="email"><h4><?php echo '新密碼';?></h4></label>
                                </div>
                            </div>

                            <div class="col-12">
                                <button class="btn btn-animation w-100 justify-content-center" name="update_pass" type="submit"><?php echo '更新密碼';?></button>
                            </div>
                        </form>
                    </div>
