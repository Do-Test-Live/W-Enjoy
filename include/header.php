                                ...
                                <div class="offcanvas offcanvas-collapse order-xl-2" id="primaryMenu">
                                    ...
                                    <div class="offcanvas-body">
                                        <ul class="navbar-nav">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="shop.php">產品</a>
                                            </li>
                                        ...
                                        for($i=0; $i<$no_fetch_cat; $i++){
                                            ...
                                            <div class="list-1 mt-3">
                                                ...
                                                for($j=0; $j<$no_fetch_sub_cat; $j++){
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="shop.php?subcat=<?php echo $fetch_sub_cat[$j]['id'];?>"><?php echo $fetch_sub_cat[$j]['sub_cat_name']?></a>
                                                        </li>
                                                    </ul>
                                                    <?php
                                                }
...
<div class="mobile-menu d-md-none d-block mobile-cart" style="background:#e92079;padding-top:17px;padding-bottom: 17px">
    <ul>
        <li class="">
            <a href="index.php">
